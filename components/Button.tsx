...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-stone-800 text-white hover:bg-stone-700 disabled:bg-stone-400",
    secondary: "bg-stone-200 text-stone-800 hover:bg-stone-300 disabled:bg-stone-100",
    outline: "border-2 border-stone-800 text-stone-800 hover:bg-stone-50 disabled:border-stone-300 disabled:text-stone-300"
  };
